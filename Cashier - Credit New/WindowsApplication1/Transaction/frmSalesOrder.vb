Public Class frmSalesOrder
    ...
    Private Sub ButtonX3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdCustomer.Click
        ...
        adnet2.loadCombo(cmbCustomer, 10, "")
    ...
    Sub load_order()
        ...
        tPPNcent.Value = Val(strArr(11))
        'tPPNamount.Value = 0.1 * (Val(strArr(8)) - Val(strArr(10)))
        tOtherfee.Value = Val(strArr(12))
        'tSubtotal.Value = Replace(Replace(strArr(13), ",", ""), ".", "")
        'tTotal.Text = strArr(13)
        txtNote.Text = strArr(31)
        tDP.Value = Val(strArr(33))
        'tLeftamount.Value = strArr(34)
        load_grid_total()
    ...
    Private Sub ButtonX2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSales.Click
        Dim adnet As adnetObj.frmSelect = New adnetObj.frmSelect()
        adnet.UrlClient = url
        adnet.newForm = False
        adnet.grid("Salesman")
        ...
        adnet.ShowDialog()
        Dim adnet2 As adnetObj.clsAdnet = New adnetObj.clsAdnet()
        adnet2.loadCombo(cmbSales, 11, "")
        cmbSales.Text = adnet.SelectedData(1)
    End Sub
    ...
    Sub Saved()
        ...
        str = str & cmbSales.SelectedValue & "|"
        ...
        If Microsoft.VisualBasic.Left(Me.Text, 3) = "Add" Then
            adnet.ExecDataAll("SOinsert", str)
        Else
            adnet.ExecDataAll("SOupdate", str)
        End If
