Public Class frmPurchasePayment
    ...
    Sub load_Setting()
        ...
        adnet.loadCounter(txtTransno, 40)
        adnet.loadCombo(cmbReport, 72, "")
    ...
    Sub Saved()
        ...
        If Microsoft.VisualBasic.Left(Me.Text, 3) = "Add" Then
            adnet.ExecDataAll("PPinsert", str)
        Else
            adnet.ExecDataAll("PPupdate", str)
        End If
    ...
    Private Sub cmbCustomer_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbCustomer.SelectedIndexChanged
        ...
        On Error Resume Next
        If Microsoft.VisualBasic.Left(Me.Text, 3) = "Add" Then
            dNet.loadGrid_Detail(grid1, 41, cmbCustomer.SelectedValue)
        End If
        load_grid_total()
    End Sub
