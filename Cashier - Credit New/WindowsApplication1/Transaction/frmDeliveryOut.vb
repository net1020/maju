Public Class frmDeliveryOut
    ...
    Private Sub ButtonX3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdCustomer.Click
        ...
        adnet2.loadCombo(cmbOrderno, 107, cmbCustomer.Text)
    ...
    Sub load_Setting()
        ...
        adnet.loadCounter(txtTransno, 55)
        adnet.loadCombo(cmbOrderno, 107, cmbCustomer.Text)
        adnet.loadCombo(cmbWarehouse, 14, "")
        adnet.loadCombo(cmbVia, 53, "")
        adnet.loadCombo(cmbReport, 91, "")
    ...
    Private Sub ButtonX4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        adnet.ShowDialog()
        Dim adnet2 As adnetObj.clsAdnet = New adnetObj.clsAdnet()
        adnet2.loadCombo(cmbOrderno, 12, "")
        cmbOrderno.Text = adnet.SelectedData(1)
    End Sub
    ...
    Private Sub cmbPayment_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbOrderno.SelectedIndexChanged
        On Error Resume Next
        'load_ppn(cmbOrderno.SelectedValue)
        If Me.Text = "Add - Delivery Out" Then
            Dim dNet As New adnetObj.clsAdnet
            Me.Tag = dNet.loadJsonFormat(108, cmbOrderno.Text)
            load_order()
        End If
    End Sub
    ...
    Sub Saved()
        ...
        str = str & cmbOrderno.SelectedValue & "|"
        str = str & "" & "|"
        ...
        str = str & cmborderno.Text & "|"



        If Microsoft.VisualBasic.Left(Me.Text, 3) = "Add" Then
            adnet.ExecDataAll("DTinsert", str)
        Else
            adnet.ExecDataAll("DTupdate", str)
        End If
    ...
    Private Sub cmbVia_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbVia.SelectedIndexChanged
    ...
    Private Sub cmdWarehouse_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdWarehouse.Click
        Dim adnet As adnetObj.frmSelect = New adnetObj.frmSelect()
        adnet.UrlClient = url
        adnet.newForm = False
        adnet.grid("warehouse")
