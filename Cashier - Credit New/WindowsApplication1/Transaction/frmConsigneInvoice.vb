Public Class frmConsigneInvoice
    ...
    Sub load_Setting()
        ...
        adnet.loadCounter(txtTransno, 44)
    ...
    Private Sub ButtonX3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdCustomer.Click
        ...
        If Me.Text = "Add - Consignment Invoice" Then
            adnet2.loadCombo(cmbRefno, 120, cmbCustomer.Text)
        End If
    End Sub
    ...
    Sub Saved()
        ...
        If Microsoft.VisualBasic.Left(Me.Text, 3) = "Add" Then
            adnet.ExecDataAll("CIinsert", str)
        Else
            adnet.ExecDataAll("CIupdate", str)
        End If
    ...
    Private Sub cmdRefno_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdRefno.Click
        ...
        If Me.Text = "Add - Consignment Invoice" Then
            Dim dNet As New adnetObj.clsAdnet
            Me.Tag = dNet.loadJsonFormat(119, cmbRefno.Text)
            load_order()
        End If
    End Sub
