Public Class frmConsigneOrder
    ...
    Sub load_Setting()
        ...
        adnet.loadCounter(txtTransno, 43)
        adnet.loadCombo(cmbReport, 80, "")
    ...
    Sub Saved()
        ...
        If Microsoft.VisualBasic.Left(Me.Text, 3) = "Add" Then
            adnet.ExecDataAll("COinsert", str)
        Else
            adnet.ExecDataAll("COupdate", str)
        End If
    ...
    Private Sub cmdEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEdit.Click
        Me.Text = "Edit - " & "Consignment Order"
        load_enabled(True)
    End Sub
