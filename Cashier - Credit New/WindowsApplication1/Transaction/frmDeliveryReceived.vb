Public Class frmDeliveryReceived
    ...
    Private Sub ButtonX4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        adnet.ShowDialog()
        Dim adnet2 As adnetObj.clsAdnet = New adnetObj.clsAdnet()
        adnet2.loadCombo(cmbDeliveryno, 12, "")
        cmbDeliveryno.Text = adnet.SelectedData(1)
    End Sub
    ...
    Sub Saved()
        ...
        str = str & cmbDeliveryno.SelectedValue & "|"
        str = str & "" & "|"
        ...
        If Microsoft.VisualBasic.Left(Me.Text, 3) = "Add" Then
            adnet.ExecDataAll("DRinsert", str)
        Else
            adnet.ExecDataAll("DRupdate", str)
        End If
