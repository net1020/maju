...
Public Class frmUserList
    ...
    Private Sub cmdRemove_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdRemove.Click
        ...
        If MsgBox("Are you confirmed to delete this record?", MsgBoxStyle.Critical + MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
            ...
            Dim json = wc.DownloadString(url & "all.php?q=247&q2=" & gridRaw1.Item(0, gridRaw1.CurrentRow.Index).Value)
            grid("User")
        End If
    End Sub
    ...
    Private Sub cmdEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEdit.Click
        frmUser.load_Group()
        frmUser.t0.Text = gridRaw1.Item(0, gridRaw1.CurrentRow.Index).Value
        frmUser.t1.Text = gridRaw1.Item(0, gridRaw1.CurrentRow.Index).Value
        frmUser.t2.Text = gridRaw1.Item(1, gridRaw1.CurrentRow.Index).Value
        frmUser.t3.Text = ""
        frmUser.t4.Text = gridRaw1.Item(3, gridRaw1.CurrentRow.Index).Value
        RowActive = gridRaw1.CurrentRow.Index
        frmUser.ShowDialog()
        grid("User")
        If RowActive < 0 Then RowActive = 0
