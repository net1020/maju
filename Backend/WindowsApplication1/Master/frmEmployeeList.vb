...
Public Class frmEmployeeList
    ...
    Private Sub cmdAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAdd.Click
        ...
        frmEmployee.t4.Text = ""
        frmEmployee.t5.Text = ""
        frmEmployee.t6.Text = Today
        frmEmployee.t7.SelectedIndex = 0
        frmEmployee.t1.Focus()
    ...
    Private Sub cmdRemove_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdRemove.Click
        ...
        If MsgBox("Are you confirmed to delete this record?", MsgBoxStyle.Critical + MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
            ...
            Dim json = wc.DownloadString(url & "all.php?q=203&q2=" & gridRaw1.Item(0, gridRaw1.CurrentRow.Index).Value)
            grid("Employee")
        End If
    End Sub

    Private Sub cmdEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEdit.Click
        frmEmployee.t0.Text = gridRaw1.Item(0, gridRaw1.CurrentRow.Index).Value
        frmEmployee.t1.Text = gridRaw1.Item(1, gridRaw1.CurrentRow.Index).Value
        frmEmployee.t2.Text = gridRaw1.Item(2, gridRaw1.CurrentRow.Index).Value
        frmEmployee.t3.Text = gridRaw1.Item(3, gridRaw1.CurrentRow.Index).Value
        frmEmployee.t4.Text = gridRaw1.Item(4, gridRaw1.CurrentRow.Index).Value
        frmEmployee.t5.Text = gridRaw1.Item(5, gridRaw1.CurrentRow.Index).Value
        frmEmployee.t6.Text = gridRaw1.Item(6, gridRaw1.CurrentRow.Index).Value
        frmEmployee.t7.Text = gridRaw1.Item(7, gridRaw1.CurrentRow.Index).Value
        RowActive = gridRaw1.CurrentRow.Index
        frmEmployee.ShowDialog()
        grid("Employee")
        If RowActive < 0 Then RowActive = 0
