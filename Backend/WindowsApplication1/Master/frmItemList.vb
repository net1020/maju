...
Public Class frmItemList
    ...
    Sub format_Grid()
        ...
        gridRaw1.Columns(11).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
    ...
    Private Sub cmdAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAdd.Click
        frmItem.load_unit()
        frmItem.load_supplier()
        frmItem.load_category()
        frmItem.t0.Text = ""
        frmItem.t1.Text = ""
        frmItem.t2.Text = ""
        frmItem.t3.Text = ""
        frmItem.t4.SelectedIndex = 0
        frmItem.t5.SelectedIndex = 0
        frmItem.t6.Text = ""
        frmItem.t7.SelectedIndex = 0
        frmItem.t8.Text = 0
        frmItem.t9.Text = 0
        frmItem.t10.Text = 0
        frmItem.t11.Text = 0
    ...
    Private Sub cmdRemove_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdRemove.Click
        ...
        If MsgBox("Are you confirmed to delete this record?", MsgBoxStyle.Critical + MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
            ...
            Dim json = wc.DownloadString(url & "all.php?q=233&q2=" & gridRaw1.Item(1, gridRaw1.CurrentRow.Index).Value)
            grid("Product")
        End If
    End Sub
    ...
    Private Sub cmdEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEdit.Click
        ...
        frmItem.load_supplier()
        frmItem.load_category()
        frmItem.t0.Text = gridRaw1.Item(0, gridRaw1.CurrentRow.Index).Value
        frmItem.t1.Text = gridRaw1.Item(1, gridRaw1.CurrentRow.Index).Value
        frmItem.t2.Text = gridRaw1.Item(2, gridRaw1.CurrentRow.Index).Value
        frmItem.t3.Text = gridRaw1.Item(3, gridRaw1.CurrentRow.Index).Value
        frmItem.t4.Text = gridRaw1.Item(4, gridRaw1.CurrentRow.Index).Value
        frmItem.t5.Text = gridRaw1.Item(5, gridRaw1.CurrentRow.Index).Value
        frmItem.t6.Text = gridRaw1.Item(6, gridRaw1.CurrentRow.Index).Value
        frmItem.t7.Text = gridRaw1.Item(7, gridRaw1.CurrentRow.Index).Value
        frmItem.t8.Text = gridRaw1.Item(8, gridRaw1.CurrentRow.Index).Value
        frmItem.t9.Text = gridRaw1.Item(9, gridRaw1.CurrentRow.Index).Value
        frmItem.t10.Text = gridRaw1.Item(10, gridRaw1.CurrentRow.Index).Value
        frmItem.t11.Text = gridRaw1.Item(11, gridRaw1.CurrentRow.Index).Value
        RowActive = gridRaw1.CurrentRow.Index
        frmItem.ShowDialog()
        grid("Product")
        If RowActive < 0 Then RowActive = 0
