...
Public Class frmCourierList
    ...
    Private Sub cmdRemove_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdRemove.Click
        ...
        If MsgBox("Are you confirmed to delete this record?", MsgBoxStyle.Critical + MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
            ...
            Dim json = wc.DownloadString(url & "all.php?q=243&q2=" & gridRaw1.Item(0, gridRaw1.CurrentRow.Index).Value)
            grid("Courier")
        End If
    End Sub

    Private Sub cmdEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEdit.Click
        frmCourier.t0.Text = gridRaw1.Item(0, gridRaw1.CurrentRow.Index).Value
        frmCourier.t1.Text = gridRaw1.Item(0, gridRaw1.CurrentRow.Index).Value
        frmCourier.t2.Text = gridRaw1.Item(1, gridRaw1.CurrentRow.Index).Value
        RowActive = gridRaw1.CurrentRow.Index
        frmCourier.ShowDialog()
        grid("Courier")
        If RowActive < 0 Then RowActive = 0
