...
Public Class frmSupplierList
    ...
    Private Sub cmdAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAdd.Click
        ...
        frmSupplier.t5.Text = ""
        frmSupplier.t6.Text = ""
        frmSupplier.t1.Text = Today
        frmSupplier.t8.Text = ""
        frmSupplier.t9.SelectedIndex = 0
        frmSupplier.t1.Focus()
    ...
    Private Sub cmdRemove_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdRemove.Click
        ...
        If MsgBox("Are you confirmed to delete this record?", MsgBoxStyle.Critical + MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
            ...
            Dim json = wc.DownloadString(url & "all.php?q=223&q2=" & gridRaw1.Item(0, gridRaw1.CurrentRow.Index).Value)
            grid("Supplier")
        End If
    End Sub

    Private Sub cmdEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEdit.Click
        If gridRaw1.CurrentRow.Index < 0 Then gridRaw1.CurrentCell = gridRaw1.Rows(0).Cells(1)
        frmSupplier.t0.Text = gridRaw1.Item(0, gridRaw1.CurrentRow.Index).Value
        frmSupplier.t1.Text = gridRaw1.Item(1, gridRaw1.CurrentRow.Index).Value
        frmSupplier.t2.Text = gridRaw1.Item(2, gridRaw1.CurrentRow.Index).Value
        frmSupplier.t3.Text = gridRaw1.Item(3, gridRaw1.CurrentRow.Index).Value
        frmSupplier.t4.Text = gridRaw1.Item(4, gridRaw1.CurrentRow.Index).Value
        frmSupplier.t5.Text = gridRaw1.Item(5, gridRaw1.CurrentRow.Index).Value
        frmSupplier.t6.Text = gridRaw1.Item(6, gridRaw1.CurrentRow.Index).Value
        frmSupplier.t1.Text = gridRaw1.Item(7, gridRaw1.CurrentRow.Index).Value
        frmSupplier.t8.Text = gridRaw1.Item(8, gridRaw1.CurrentRow.Index).Value
        frmSupplier.t9.Text = gridRaw1.Item(9, gridRaw1.CurrentRow.Index).Value
        RowActive = gridRaw1.CurrentRow.Index
        frmSupplier.ShowDialog()
        grid("Supplier")
        If RowActive < 0 Then RowActive = 0
