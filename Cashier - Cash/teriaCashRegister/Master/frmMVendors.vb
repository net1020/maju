...
Public Class frmMVendors
    ...
    Public Sub grid(ByVal str2 As String)
        ...
        Dim json = wc.DownloadString(Url & "pos.php?q=33&q2=" & str2 & "&p=" & AdnetNavigation1.pageActive)
    ...
    Public Function totalRec() As Integer
        Dim wc As New WebClient()
        Dim json = wc.DownloadString(Url & "pos.php?q=34")
    ...
    Private Sub ButtonItem4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonItem4.Click
        frmMVendor.load_counter()
        frmMVendor.t1.Focus()
        frmMVendor.ShowDialog()
    End Sub
