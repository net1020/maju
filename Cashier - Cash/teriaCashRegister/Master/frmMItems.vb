...
Public Class frmMItems
    ...
    Public Sub grid(ByVal str2 As String)
        ...
        Dim json = wc.DownloadString(Url & "pos.php?q=63&q2=" & str2 & "&p=" & AdnetNavigation1.pageActive)
    ...
    Public Function totalRec() As Integer
        Dim wc As New WebClient()
        Dim json = wc.DownloadString(Url & "pos.php?q=64")
