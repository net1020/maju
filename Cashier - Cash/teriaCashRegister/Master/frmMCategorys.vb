...
Public Class frmMCategorys
    ...
    Public Sub grid(ByVal str2 As String)
        ...
        Dim json = wc.DownloadString(Url & "pos.php?q=53&q2=" & str2 & "&p=" & AdnetNavigation1.pageActive)
    ...
    Public Function totalRec() As Integer
        Dim wc As New WebClient()
        Dim json = wc.DownloadString(Url & "pos.php?q=54")
    ...
    Private Sub ButtonItem4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonItem4.Click
        frmMCategory.load_counter()
        frmMCategory.t1.Focus()
        frmMCategory.ShowDialog()
    End Sub
